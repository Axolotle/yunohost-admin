...
import { ref, shallowRef, type Ref, isRef, computed } from 'vue'
...
import d from '@/types/core/fakeAppInstall.json'
...
const formData = shallowRef<
  | {
      ...
      onSubmit: (fn: (onError: (err: APIError) => void) => void) => void
    }
  | undefined
>()
...
async function performInstall(onError: (err: APIError) => void) {
  ...
  console.log('onperforminstall', form.value)
